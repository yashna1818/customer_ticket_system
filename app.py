...
<style>
    ...
    html, body, .stMarkdown, p, label, td, th {
    ...
    /* Style custom tabs navigation bar for a premium look */
    div.top-nav-bar {
    ...
    div.top-nav-bar div[data-testid="column"] button {
    ...
    div.top-nav-bar div[data-testid="column"] button:hover {
        color: #6C63FF !important;
        background-color: rgba(255, 255, 255, 0.02) !important;
    }
    div.top-nav-bar div[data-testid="column"] button[kind="primary"] {
        color: #FF6584 !important;
        border-bottom: 2px solid #FF6584 !important;
        background-color: transparent !important;
    }
</style>
...
# Custom Top Tab Navigation Menu
tab_titles = [
...
if "active_tab" not in st.session_state:
    st.session_state.active_tab = "🏢 Departments Overview"
...
app_mode = st.session_state.active_tab
